...
//        NSLog(@"111   %@", self.foodDetailModel.course_name);
//  //////////////
...
//            NSLog(@"222   %@", everydayEat.course_name);
...
- (void)creatAVPlayer {
    ...
    [self.avPlayer playWithUrl:@"http://www.iqiyi.com/v_19rrloal6k.html?vfm=2008_aldbd&bvfm=videolocal"];
